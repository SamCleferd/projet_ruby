class GameWindow < Hasu::Window
  ...
  def initialize
    ...
    @background_sprite = Gosu::Image.new(self, 'images/route.png', true)
    @koala_sprite = Gosu::Image.new(self, 'images/captain.png', true)
    @enemy_sprite = Gosu::Image.new(self, 'images/hulk.png', true)
    @flag_sprite = Gosu::Image.new(self, 'images/princess.png', true)
    @font = Gosu::Font.new(self, Gosu::default_font_name, 30)
    @flag = {x: WINDOW_X - SPRITE_SIZE, y: WINDOW_Y - SPRITE_SIZE}
    @music = Gosu::Song.new(self, "musics/wii_Super_Mario_Galaxy_ecran_titre.wav")
    reset
  end
