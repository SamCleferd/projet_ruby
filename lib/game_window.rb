class GameWindow < Hasu::Window
  ...
  def initialize
    ...
    @background_sprite = Gosu::Image.new(self, 'images/back5.png', true)
    @koala_sprite = Gosu::Image.new(self, 'images/smiley.png', true)
    @enemy_sprite = Gosu::Image.new(self, 'images/mechant.png', true)
